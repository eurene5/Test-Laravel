	                ...
	                <form class="card" action="<?php echo e(route($client->exists ? 'commerciale.client.update' : 'commerciale.client.store', $client)); ?>" method="post">
	                    ...
	                    <div class="card-footer text-end">
							<?php if($client->exists): ?>
								<?php echo $__env->make('shared.btn-modal', ['btn' => 'btn-primary', 'action' => 'Enregistrer', 'id' => "update"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
							<?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Poem\Documents\Projets\viho-laravel-10\resources\views/admin/apps/commerciale/client/form.blade.php ENDPATH**/ ?>